...
#......................................SERVO SETUP............................................................
PWM_PIN=32 #use GPIO12(BCM) pin 32(*BOARD)
...
class Drive(): #to call the objects functions  moveF ,moveB,STOP,LEFT,RIGHT
    def __init__(self,Ena,In1,In2,Enb,In3,In4):
        ...
        self.pwm = GPIO.PWM(self.Ena,1000) #set pwm pin and a frequency of 1kHz
        self.pwm = GPIO.PWM(self.Enb,1000)
        self.pwm.start(0)


    def moveF(self,speed=80,Time =10): #move Forward motors rotate in the same direction  to call it........... Drive1.moveF(Duty Cycle ,Time to move forward).........
        ...
        sleep(Time)
    def moveB(self,speed=80,Time =2): #move ackward motors rotate in the oposite direction to call it........... Drive1.move(Duty Cycle ,Time to reverse).........
    ...
    def STOP(self,Time =2):  #stop motors puling in pins low stops the lm298 to call it........... Drive1.STOP(STOP time else it will stop for 2 sec).........
        ...
        GPIO.output(self.In3,GPIO.LOW)
        GPIO.output(self.In4,GPIO.LOW)
        pwm.ChangeDutyCycle(0) #0% pwm duty cycle
        sleep(Time) 
...
Drive1 = Drive(13,14,16,33,18,20)
